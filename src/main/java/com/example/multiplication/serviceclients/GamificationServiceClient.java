...
public class GamificationServiceClient {
    ...
    public boolean sentAttempt(final ChallengeAttempt attempt) {
        try {
            ...
            ResponseEntity<String> r = restTemplate.postForEntity(gamificationHostUrl +
                    "/attempts", dto, String.class);
